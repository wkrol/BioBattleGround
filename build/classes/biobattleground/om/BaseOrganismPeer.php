...
abstract class BaseOrganismPeer {
	...
	const OM_CLASS = 'Organism';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'biobattleground.Organism';
	...
	/** the column name for the INSTINCT field */
	const INSTINCT = 'organism.INSTINCT';

	/** the column name for the TOUGHNESS field */
	const TOUGHNESS = 'organism.TOUGHNESS';

	/** the column name for the VITALITY field */
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = OrganismPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + OrganismPeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? OrganismPeer::CLASS_DEFAULT : OrganismPeer::OM_CLASS;
	}
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(OrganismPeer::ID) && $criteria->keyContainsValue(OrganismPeer::ID) ) {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(OrganismPeer::ID, (array) $values, Criteria::IN);
		}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = OrganismPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {
			...
			$criteria->add(UserPrivilegesPeer::ID_ORGANISM, $obj->getId());
			...
			$criteria->add(GroupPeer::ID_ORGANISM, $obj->getId());
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(OrganismPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(OrganismPeer::DATABASE_NAME);
			$criteria->add(OrganismPeer::ID, $pks, Criteria::IN);
