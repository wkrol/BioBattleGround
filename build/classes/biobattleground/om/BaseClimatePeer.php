...
abstract class BaseClimatePeer {
	...
	const TABLE_NAME = 'climate';

	/** the related Propel class for this table */
	const OM_CLASS = 'Climate';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'biobattleground.Climate';
	...
	const NAME = 'climate.NAME';

	/** the column name for the SUN field */
	const SUN = 'climate.SUN';

	/** the column name for the RAIN field */
	 ...
	 * @param      string $column The column name for current table. (i.e. ClimatePeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(ClimatePeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(ClimatePeer::TABLE_NAME);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = ClimatePeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return ClimatePeer::populateObjects(ClimatePeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      mixed $value A Climate object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Climate) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Climate object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     Climate Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to climate
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ClimatePeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ClimatePeer::NUM_COLUMNS;
		} else {
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseClimatePeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseClimatePeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new ClimateTableMap());
	  }
	}
	...
	{
		return $withPrefix ? ClimatePeer::CLASS_DEFAULT : ClimatePeer::OM_CLASS;
	}
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Climate object
		}

		if ($criteria->containsKey(ClimatePeer::ID) && $criteria->keyContainsValue(ClimatePeer::ID) ) {
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			ClimatePeer::clearInstancePool();
			ClimatePeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Climate) { // it's a model object
			// create criteria based on pk values
			$criteria = $values->buildPkeyCriteria();
		} else { // it's a primary key, or an array of pks
			$criteria = new Criteria(self::DATABASE_NAME);
			$criteria->add(ClimatePeer::ID, (array) $values, Criteria::IN);
		}
		...
		try {
			...
			if ($values instanceof Criteria) {
				...
				ClimatePeer::removeInstanceFromPool($values);
			} else { // it's a primary key, or an array of pks
				foreach ((array) $values as $singleval) {
					ClimatePeer::removeInstanceFromPool($singleval);
				}
			}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = ClimatePeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {
			...
			$criteria->add(UserPrivilegesPeer::ID_CLIMATE, $obj->getId());
	...
	/**
	 * Validates all modified columns of given Climate object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Climate $obj The object to validate.
	...
	public static function doValidate(Climate $obj, $cols = null)
	{
		...
		if ($cols) {
			$dbMap = Propel::getDatabaseMap(ClimatePeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(ClimatePeer::TABLE_NAME);
		...
		return BasePeer::doValidate(ClimatePeer::DATABASE_NAME, ClimatePeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = ClimatePeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(ClimatePeer::ID, $pk);

		$v = ClimatePeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ClimatePeer::DATABASE_NAME);
			$criteria->add(ClimatePeer::ID, $pks, Criteria::IN);
			$objs = ClimatePeer::doSelect($criteria, $con);
		}
		return $objs;
	}
